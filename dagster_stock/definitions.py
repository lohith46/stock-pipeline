...
from dagster_stock.jobs.jobs import (
    bronze_job,
    staging_job,
    invalid_job,
    reference_job,
...
staging_assets   = load_assets_from_modules([staging],   group_name="staging")
invalid_assets   = load_assets_from_modules([invalid],   group_name="invalid")
reference_assets = load_assets_from_modules([reference], group_name="reference")
